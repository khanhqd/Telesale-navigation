  ...
  render() {
    return (
      <View style={{flex:1}}>
        ...
        <ScrollView style={{flex:1, paddingLeft:3}}>
          <Image
            style={{width: width, height: width*0.75}}
            source={ require('../../img/banner-pizza.png')} />
            <Text
            style={{backgroundColor:'#1C2436', color:'white', fontWeight:'bold', fontSize:25, textAlign:'center', paddingTop:10}}>Pizzas of the month
            </Text>
            <View
